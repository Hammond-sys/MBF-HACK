...
def login():
	...
	if 'save-device' in url or 'm_sess' in url:
		...
		cetak('!h[*] Semoga hari anda menyenangkan kawan-kawan...')
		log = 1
...
def idteman():
	...
	if i.upper() == 'Y':
		...
		return menu()
def menu():
	cetak("\n           !h.-.-..\n          /+/++//\n         /+/++//\n  !k*   !k* !h/+/++//\n   \ /  |/__//\n !h{!mX!h}v{!mX!h}!0!b|!cMBF!b|==========.\n   !h(!m'!h)!0  !h/'|'\           !b\\\n       !h/  \  \          !b'\n       !h\_  \_ \_   !k___!mMBF !c2.0!k___\n\n !m* !bMULTI BRUTEFORCE FACEBOOK\n !m* !cHAMMOND\n !m* !phttps://github.com/Hammond-sys\n !m* !pGUNAKAN DENGAN BIJAK YA!\n !m* !pHAMMOND-SECURITY-CYBER-TEAM\n!k.======================.\n|!h  AMBIL !mID!h DARI.....  !k|\n'======================'\n!k#!p1 !hDAFTAR TEMAN MU\n!k#!p2 !hANGGOTA GROUPMU\n!k#!p3 !mKELUAR PECUNDANG...")
	i = inputM('[?] MAU PILIH',[1,2,3])
	if i == 2:
		lanjutG()
		idgroup()
	elif i == 1:
